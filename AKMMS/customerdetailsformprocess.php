...
$sqlCheck = "SELECT COUNT(*) as count FROM tb_customer WHERE c_idnum = '$cidnum'";
$resultCheck = mysqli_query($con, $sqlCheck);
$rowCheck = mysqli_fetch_assoc($resultCheck);

if ($rowCheck['count'] > 0) {
    // If customer ID already exists, display an error message or redirect to a page
    echo "Customer ID already exists. Please insert a different ID.";
} else {
    // Insert New Customer
